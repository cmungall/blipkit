...
io:write_all(obolog_prolog(Args),_,_):-
        ...
        nl,
        write_comment('Core axioms'),
        forall(writeable_formula(A),
               write_axiom(obolog_prolog,A)).
        write_comment('Ontology rules'),
        forall(axiomtemplate(A),
               forall(A,write_axiom(obolog_prolog,A))),
        write_comment('Expanded axioms'),
	fetch_expansions_rules(Args,Rules),
        forall(expanded_formula(A,Rules),
               write_axiom(obolog_prolog,A)).
