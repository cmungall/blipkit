...
ontol_db:class(Gene):- gene_symbol(GeneLoc,_),localid_globalid(GeneLoc,Gene).
...
ontol_db:subclass(Gene,'SO:0000704'):- gene_symbol(GeneLoc,_),localid_globalid(GeneLoc,Gene).
...
ontol_db:restriction(Gene,'OBO_REL:located_in',Chrom):- gene_chromosome(GeneLoc,ChromLoc),localid_globalid(GeneLoc,Gene),gene_taxon(GeneLoc,TaxId),chromosome_globalid(ChromLoc,Chrom,TaxId).
ontol_db:restriction(Gene,part_of_organism,Sp):- gene_taxon(GeneLoc,TaxId),atom_concat('NCBITaxon:',TaxId,Sp),localid_globalid(GeneLoc,Gene).
