...
:- module(ontol_bridge_to_simple_rdf,[
                               force_ns/1,
                               get_triple/3,
                               rdf_assertall/0
                               ]).

% currently has a lot of repeated code with the deprecated bridge to owl
...
% THIS IS UNIQUE TO SIMPLE RDF MODEL
% don't use owl mapping
derived_triple(Sbj,Prop,Obj):-
        restriction(Sbj,Prop,Obj).
