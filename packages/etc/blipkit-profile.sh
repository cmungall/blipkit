...
alias diseaseplus="ov -r disease -r hsap/phenotype-DO -r HP"
alias mpath="ov -r mpath"
alias qmpath="oq -r mpath"
alias fma="ov -r FMA -rel subclass -rel part_of"
alias qfma="oq -r FMA"
alias sfma="ov -r fma_simple"
alias qsfma="oq -r fma_simple"
alias fma3="ech deprecated"
alias qfma3="ech deprecated"
...
alias nifa="ov -r NIFGA"
alias qnifa="oq -r NIFGA"
...
alias nlxa="ov -r nlxa"
alias qnlxa="oq -r nlxa"
...
export MPX='-r go -r pext -rel inheres_in -rel subclass -rel part_of -rel capable_of'
alias mpx="ov -r mpx $MPX"
alias qmpx="oq -r mpx $MPX -showxp"
...
alias qmondo='oq -r mondo'
alias mondo='ov -r mondo  -u ontol_config_do -cr part_of'
alias qmonarch='oq -r monarch -r hp_xp -r mp_xp -r zp'
alias monarch='ov -r monarch -r hp_xp -r mp_xp -r zp'
alias qdiseasex='oq -r disease_xp -showxp'
...
export GO_XP_ARGS="-r go_xp_dev -r go_xp"
...
alias goplus="ov -r go_mg"
alias qgoplus="oq -r go_mg"
