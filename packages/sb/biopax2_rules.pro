:- module(biopax2_rules,
          [
           ...
           reaction_output/2,
           biopax_entity_class/2,
           biopax_entity_class_lexmatch/2,
           biopax_class_correlation/4
           ]).
...
biopax_entity_class_lexmatch(E,C):-
        E biopax_name N,
        match_name(N,C).
...
biopax_entity_class(E,Class):-
        oboxref(E,Class),
        class(Class).

biopax_class_correlation(C1,C2,C1N,C2N):-
        pathway(P),
        biopax_entity_class(P,C1),
        has_subpathwayRT(P,SubP),
        rdf_has(SubP,_,E),
        biopax_entity_class(E,C2),
        class(C1,C1N),
        class(C2,C2N).
